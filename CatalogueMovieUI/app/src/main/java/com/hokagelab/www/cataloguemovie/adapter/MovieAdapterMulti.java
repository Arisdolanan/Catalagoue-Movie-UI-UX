...
public class MovieAdapterMulti extends RecyclerView.Adapter<MovieAdapterMulti.ViewHolder>{
    private static final String TAG = "MovieAdapter";
    private List<Result> mMovieList;

    public MovieAdapterMulti(List <Result> MovieList){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_multi, parent, false);
